package app.getupcoming.feature.scheduling
...
import app.getupcoming.core.designsystem.GeometricSectionHeader
import app.getupcoming.core.designsystem.UpcomingTopBar
import app.getupcoming.core.network.SingleUseLinkDto
import app.getupcoming.core.util.generateQrBitmap
...
private fun LinkStatusBadge(status: String) {
    val (label, color) = when (status) {
        "unused" -> "UNUSED" to app.getupcoming.ui.theme.SemanticSuccess
